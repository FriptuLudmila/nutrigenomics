      ...
      <header className="bg-white border-b border-slate-200">
        <div className="container mx-auto px-4 py-6 max-w-7xl">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-slate-900">Nutrigenomics Analysis</h1>
              <p className="text-sm text-slate-600 mt-1">Personalized nutrition based on your genetics</p>
            </div>
          </div>
        </div>
      </header>
